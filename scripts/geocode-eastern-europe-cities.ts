/**
 * Writes curated city coordinates for Eastern Europe clubs.
 * Run: npx tsx scripts/geocode-eastern-europe-cities.ts
 */
import fs from 'fs/promises'
import { EASTERN_EUROPE_CITY_COORDS } from './data/eastern-europe-clubs.js'
...
async function main() {
  ...
  for (const [countryCode, coords] of Object.entries(EASTERN_EUROPE_CITY_COORDS)) {
  ...
  console.log(`\nDone. ${total} Eastern Europe city coordinates added/updated.`)
}
