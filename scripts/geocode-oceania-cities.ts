/**
 * Writes curated city coordinates for Oceania clubs.
 * Run: npx tsx scripts/geocode-oceania-cities.ts
 */
import fs from 'fs/promises'
import { OCEANIA_CITY_COORDS } from './data/oceania-clubs.js'
...
async function main() {
  ...
  for (const [countryCode, coords] of Object.entries(OCEANIA_CITY_COORDS)) {
  ...
  console.log(`\nDone. ${total} Oceania city coordinates added/updated.`)
}
