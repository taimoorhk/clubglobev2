/**
 * Writes curated city coordinates for Icelandic clubs.
 * Run: npx tsx scripts/geocode-iceland-cities.ts
 */
import fs from 'fs/promises'
import { ICELAND_CITY_COORDS } from './data/iceland-clubs.js'
...
async function main() {
  ...
  for (const [countryCode, coords] of Object.entries(ICELAND_CITY_COORDS)) {
  ...
  console.log(`\nDone. ${total} Iceland city coordinates added/updated.`)
}
